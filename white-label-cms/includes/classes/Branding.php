...
class WLCMS_Branding extends WLCMS_Previewable
{
    ...
    public function admin_bar_logo( $wp_admin_bar )
    {
        ...
        $args = array(
            ...
            'meta'  => array( 'class' => 'wlcms-admin-logo', 'title' => $admin_menu_bar_alt_text )
        );
        ...
        wlcms_set_css('.wlcms-admin-logo .ab-item, .wlcms-admin-logo a', array('line-height' => '28px!important'));
    ...
    public function admin_menu()
    {
        ...
        if($sidebar_url) {
            $logo =  sprintf('<a href=\"%s\" title=\"%s\">%s</a>', $sidebar_url, $sidebar_text, $logo);
        }
