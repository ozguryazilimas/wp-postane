...
$generated_i18n_strings = array(
	...
	// Reference: src/modules/tools/components/ToolsTabUrlBuilder.vue:153
	...
	// Reference: src/modules/tools/components/ToolsTabUrlBuilder.vue:163
	...
	// Reference: src/modules/tools/components/ToolsTabUrlBuilder.vue:180
	__( 'More Information & Examples', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/ToolsTabUrlBuilder.vue:181
	...
	// Reference: src/modules/tools/components/ToolsTabUrlBuilder.vue:198
	...
	// Reference: src/modules/tools/components/ToolsTabUrlBuilder.vue:200
	/* Translators: Example. */
	__( 'Example: %s', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/tools/components/ToolsTabUrlBuilder.vue:202
	...
	// Reference: src/modules/tools/components/ToolsTabUrlBuilder.vue:225
	...
	__( 'Custom Dimensions show you popular categories, best time to publish, focus keywords, etc.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/widget/components/WidgetTips.vue:29
	__( 'Make Google Analytics GDPR compliant with our EU Compliance addon.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/widget/components/WidgetTips.vue:34
	__( 'Get real-time Google Analytics report right inside your WordPress dashboard.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/widget/components/WidgetTips.vue:39
	__( 'Use Google Optimize to easily perform A/B split tests on your site.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/widget/components/WidgetTips.vue:44
	__( 'See all your important store metrics in one place with Enhanced Ecommerce Tracking.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/widget/components/WidgetTips.vue:49
	__( 'Unlock search console report to see your top performing keywords in Google.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/widget/components/WidgetTips.vue:54
	__( 'Get Page Insights to see important metrics for individual posts / pages in WordPress.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/widget/components/WidgetTips.vue:59
	__( 'Publishers Report shows your top performing pages, audience demographics, and more.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/widget/components/WidgetTips.vue:64
	__( 'Get Scroll-Depth tracking to see how far users scroll on your pages before leaving.', 'google-analytics-dashboard-for-wp' ),
