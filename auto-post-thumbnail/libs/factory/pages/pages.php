<?php
	...
	add_action('admin_menu', 'Wbcr_FactoryPages462::actionAdminMenu');
	add_action('network_admin_menu', 'Wbcr_FactoryPages462::actionAdminMenu');
	...
	if( !class_exists('Wbcr_FactoryPages462') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryPages462 {

			/**
			 * @var Wbcr_FactoryPages462_Page[]
			 */
			...
			public static function getPageUrl(Wbcr_Factory462_Plugin $plugin, $page_id, $args = array())
			{
				if( isset(self::$pages[$plugin->getPluginName()]) ) {
	...
	if( !function_exists('wbcr_factory_pages_462_get_page_id') ) {
		/**
		 *
		 * @param Wbcr_Factory462_Plugin $plugin
		 ...
		 * @return string
		 */
		function wbcr_factory_pages_462_get_page_id($plugin, $page_id)
		{
