...
namespace WBCR\Factory_Freemius_150\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory463_Plugin;
use WBCR\Factory_463\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_150\Premium\Provider
	 */
	private $premium;
	...
	{
		if( !$this->premium instanceof \WBCR\Factory_Freemius_150\Premium\Provider ) {
