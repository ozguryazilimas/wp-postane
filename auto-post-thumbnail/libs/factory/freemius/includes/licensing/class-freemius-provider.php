...
namespace WBCR\Factory_Freemius_149\Premium;

use WBCR\Factory_Freemius_149\Entities\License;
use WBCR\Factory_Freemius_149\Entities\Plugin;
use WBCR\Factory_Freemius_149\Entities\Site;
use WBCR\Factory_Freemius_149\Entities\User;
use WBCR\Factory_462\Premium\Provider as License_Provider;
use Wbcr_Factory462_Plugin;
use WBCR\Factory_Freemius_149\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_149\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory462_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_149\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_149\Api
	 * @throws Exception
	 */
