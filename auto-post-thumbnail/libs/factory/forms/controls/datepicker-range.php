<?php
	...
	if( !class_exists('Wbcr_FactoryForms459_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms459_DatepickerRangeControl extends Wbcr_FactoryForms459_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms459_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms459_TextboxControl($options['range_2'], $form, $provider);
