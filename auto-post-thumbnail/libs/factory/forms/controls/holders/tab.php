<?php
	...
	if( !class_exists('Wbcr_FactoryForms459_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms459_TabHolder extends Wbcr_FactoryForms459_Holder {
			 ...
			 * @param FactoryForms459_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms459_HtmlAttributeBuilder();
