<?php
	...
	if( !class_exists('Wbcr_FactoryForms460_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms460_TabHolder extends Wbcr_FactoryForms460_Holder {
			 ...
			 * @param FactoryForms460_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms460_HtmlAttributeBuilder();
