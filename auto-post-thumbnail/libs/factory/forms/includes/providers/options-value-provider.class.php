<?php
	...
	if( !class_exists('Wbcr_FactoryForms459_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms459_OptionsValueProvider implements Wbcr_IFactoryForms459_ValueProvider {
