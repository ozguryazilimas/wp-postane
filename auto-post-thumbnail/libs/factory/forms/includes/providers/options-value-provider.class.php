<?php
	...
	if( !class_exists('Wbcr_FactoryForms460_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms460_OptionsValueProvider implements Wbcr_IFactoryForms460_ValueProvider {
