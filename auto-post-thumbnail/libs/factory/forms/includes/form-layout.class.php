<?php
	...
	if( !class_exists('Wbcr_FactoryForms459_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms459_FormLayout extends Wbcr_FactoryForms459_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-459-' . $this->type);
				$this->addCssClass('factory-forms-459-' . $this->name);
			}
