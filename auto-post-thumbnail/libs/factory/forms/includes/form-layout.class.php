<?php
	...
	if( !class_exists('Wbcr_FactoryForms460_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms460_FormLayout extends Wbcr_FactoryForms460_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-460-' . $this->type);
				$this->addCssClass('factory-forms-460-' . $this->name);
			}
