<?php
	...
	if( !class_exists('Wbcr_FactoryForms460_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms460_Control extends Wbcr_FactoryForms460_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms460_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms460_ValueProvider $provider
			 * @return void
			 */
