 ...
 *
 * Этот класс унаследован от стандартного шаблона страницы \Wbcr_FactoryPages462_ImpressiveThemplate,
 ...
 *
 * @package WBCR\Factory_Templates_113\Pages
 * @author        Alex Kovalev <alex.kovalevv@gmail.com>, Github: https://github.com/alexkovalevv
 * @since         2.2.2
 */
class Setup extends \WBCR\Factory_Templates_113\Impressive {
	...
	public function __construct(\Wbcr_Factory462_Plugin $plugin)
	{
		...
		$this->menu_title = __('Setup master', 'wbcr_factory_templates_113');
		$this->page_menu_short_description = __('Setup master', 'wbcr_factory_templates_113');
		parent::__construct($plugin);
	}

	public function getPageTitle()
	{
		return __('Setup', 'wbcr_factory_templates_113');
	}
	...
	public function assets($scripts, $styles)
	{
		...
		$this->styles->add(FACTORY_TEMPLATES_113_URL . '/assets/css/page-setup.css');
	...
	{
		?>
		<div class="w-factory-templates-113-setup">
			<ol class="w-factory-templates-113-setup-steps">
			...
			<div class="w-factory-templates-113-setup-content">
				<?php echo $content; ?>
			</div>
			<a class="w-factory-templates-113-setup-footer-links" href="<?php echo esc_url($this->get_close_wizard_url()); ?>">
				<?php _e('Not now', 'wbcr_factory_templates_113') ?>
			</a>
		</div>
		<?php
	}
