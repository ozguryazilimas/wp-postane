...
class Step_Form extends Step {
	...
	public function __construct(\WBCR\Factory_Templates_113\Pages\Setup $page)
	{
	...
	protected function render_form(\Wbcr_FactoryForms460_Form $form)
	{
		...
		<form method="post" id="w-factory-templates-113__setup-form-<?php echo $this->get_id() ?>" class="w-factory-templates-113__setup-form form-horizontal">
			<?php $form->html(); ?>
			<div class="w-factory-templates-113__form-buttons">
				...
				<input type="submit" name="continue_button_<?php echo $this->get_id() ?>" class="button-primary button button-large w-factory-templates-113__continue-button" value="<?php _e('Continue', 'wbcr_factory_templates_113') ?>">
			</div>
		</form>
		<?php
	}
