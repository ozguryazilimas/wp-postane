...
(function($) {
	...
	$.wbcr_factory_templates_112.filters = $.wbcr_factory_templates_112.filters || $.wfactory_460.filters;
	//todo: Переопредление для совместимости со старыми версиями плагинов.
	$.wbcr_factory_templates_112.hooks = $.wbcr_factory_templates_112.hooks || $.wfactory_460.hooks;
	...
	$.wbcr_factory_templates_112.app = $.wbcr_factory_templates_112.app || {
		...
		showNotice: function(message, type) {
			...
			$([document.documentElement, document.body]).animate({
				 ...
				 * Пример регистрации хука $.wfactory_460.hooks.add('wbcr/factory_templates_112/updated',
				 * function(noticeId) {});
				 * @param {string} noticeId - id уведомления
				 */
				$.wfactory_460.hooks.run('wbcr/factory_templates_112/showed_notice', [noticeId]);
		...
		hideNotice: function(noticeId) {
			...
			el.fadeOut(500, function(e) {
				 ...
				 * @param {string} noticeId - id уведомления
				 */
				$.wfactory_460.hooks.run('wbcr/factory_templates_112/hidded_notice', [noticeId]);
