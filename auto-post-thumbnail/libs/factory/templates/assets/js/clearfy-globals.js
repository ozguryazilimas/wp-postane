...
(function($) {
	...
	$.wbcr_factory_templates_103.filters = $.wbcr_factory_templates_103.filters || $.wfactory_450.filters;
	//todo: Переопредление для совместимости со старыми версиями плагинов.
	$.wbcr_factory_templates_103.hooks = $.wbcr_factory_templates_103.hooks || $.wfactory_450.hooks;
	...
	$.wbcr_factory_templates_103.app = $.wbcr_factory_templates_103.app || {
		...
		showNotice: function(message, type) {
			...
			$([document.documentElement, document.body]).animate({
				 ...
				 * Пример регистрации хука $.wfactory_450.hooks.add('wbcr/factory_templates_103/updated',
				 * function(noticeId) {});
				 * @param {string} noticeId - id уведомления
				 */
				$.wfactory_450.hooks.run('wbcr/factory_templates_103/showed_notice', [noticeId]);
		...
		hideNotice: function(noticeId) {
			...
			el.fadeOut(500, function(e) {
				 ...
				 * @param {string} noticeId - id уведомления
				 */
				$.wfactory_450.hooks.run('wbcr/factory_templates_103/hidded_notice', [noticeId]);
