...
use WBCR\Factory_Templates_105\ImpressiveLite;
...
class WAPT_Page_Logger extends Wbcr_FactoryLogger117_Lite {
	...
	public function showSupportWidget() {
		...
		<div id="wbcr-clr-support-widget" class="wbcr-factory-sidebar-widget">
			...
			<div class="wbcr-clr-support-widget-body">
				<p>
					<?php esc_html_e( 'We provide free support for this plugin. If you are pushed with a problem, just create a new ticket. We will definitely help you!', 'wbcr_factory_templates_105' ); ?>
				</p>
				<ul>
