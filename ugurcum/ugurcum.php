...
function ugurcum_add_assets() {
  ...
  wp_register_script('jquery_datatables_js','//cdn.datatables.net/1.10.1/js/jquery.dataTables.js');
  wp_enqueue_script('jquery_datatables_js');

  wp_register_style('jquery_datatables_css', '//cdn.datatables.net/1.10.1/css/jquery.dataTables.css');
